...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('vodkamartiniarticle_article', (
        ...
        db.send_create_signal('vodkamartiniarticle', ['Article'])

        # Adding M2M table for field categories on 'Article'
        db.create_table('vodkamartiniarticle_article_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm['vodkamartiniarticle.article'], null=False)),
            ('category', models.ForeignKey(orm['vodkamartinicategory.category'], null=False))
        ))
        db.create_unique('vodkamartiniarticle_article_categories', ['article_id', 'category_id'])


    def backwards(self, orm):
        # Deleting model 'Article'
        db.delete_table('vodkamartiniarticle_article')

        # Removing M2M table for field categories on 'Article'
        db.delete_table('vodkamartiniarticle_article_categories')
